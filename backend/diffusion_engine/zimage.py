...
class ZImage(ForgeDiffusionEngine):
    """Forge glue only: Comfy ``NextDiT`` UNet + Comfy ``sd.CLIP`` (Z-Image TE)."""

    matched_guesses = [model_list.ZImage, model_list.ZImageBase]
    ...
    def __init__(self, estimated_config, huggingface_components):
        ...
        self.text_processing_engine_gemma = Qwen3TextProcessingEngine(clip)
