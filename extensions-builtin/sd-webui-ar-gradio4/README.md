# Stable Diffusion WebUI Aspect Ratio selector (Gradio 4 Compatible)

> **Note:** This is a Forge/Gradio 4.x compatible fork of the original extension.
> 
> - **Original:** [alemelis/sd-webui-ar](https://github.com/alemelis/sd-webui-ar)
> - **Tested on:** Stable Diffusion WebUI Forge with Gradio 4.40+

Extension for [AUTOMATIC1111/stable-diffusion-webui](https://github.com/AUTOMATIC1111/stable-diffusion-webui.git) and Forge adding image aspect ratio selector buttons.

## Why This Fork?

The original [sd-webui-ar](https://github.com/alemelis/sd-webui-ar) extension was designed for Gradio 3.x and is not compatible with newer versions of Stable Diffusion WebUI Forge that use Gradio 4.x. This fork updates the extension to work seamlessly with Gradio 4.40 and later versions.

### Key Changes

- Updated button creation to use Gradio 4.x API
- Fixed component interaction methods for Gradio 4.x compatibility
- Maintained all original features and functionality
- Fully compatible with WebUI Forge

## Install

Browse to the `Extensions` tab -> go to `Install from URL` -> paste in `https://github.com/ussoewwin/sd-webui-ar-gradio4` -> click `Install`

## Updates

- **Gradio 4 Compatibility:** Complete rewrite for Gradio 4.x support
- 20/02/2023 ⚠️ The original update will remove your local config files (`aspect_ratios.txt` and `resolutions.txt`) and create new default ones. These can be modified freely and preserved in the future. For more info read [here](https://github.com/alemelis/sd-webui-ar/issues/9).
...
- ✅ **Stable Diffusion WebUI Forge** with Gradio 4.40+
- ✅ **AUTOMATIC1111 WebUI** (newer versions with Gradio 4.x)
- ❌ Older WebUI versions with Gradio 3.x (use the [original extension](https://github.com/alemelis/sd-webui-ar) instead)

## Troubleshooting

### Extension Not Working After Installation

1. Make sure you're using a WebUI version that supports Gradio 4.x
2. Restart the WebUI completely after installing the extension
3. Check the console for any error messages

### Buttons Not Appearing

1. Check that the extension is enabled in the `Extensions` tab
2. Try refreshing the browser page
3. Clear your browser cache

### Aspect Ratios Not Applying Correctly

1. Make sure your `aspect_ratios.txt` and `resolutions.txt` files are properly formatted
2. Check the console for parsing errors
3. Try restoring the default configuration files by deleting them and restarting the WebUI
...
- **Original Extension:** [alemelis/sd-webui-ar](https://github.com/alemelis/sd-webui-ar) by Alessandro Melchiori
- **Gradio 4 Port:** This fork

## License

MIT License - See [LICENSE](LICENSE) file for details.

This project maintains the original MIT license and gives credit to the original author.
