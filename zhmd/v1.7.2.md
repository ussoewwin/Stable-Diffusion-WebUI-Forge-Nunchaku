...
**不在范围内：** Lumina Comfy import Step 1（`LUMINA_ZIMAGE_COMFY_IMPORT_PLAN.md`，仅本地 `docs/` 开发笔记，不入库）。
...
└──────────────────────────────────────┘
 ...
 Comfy detect              ┌──────────────────────────────────────┐
 → anima                   │ Lumina?                              │
                           │ (cap_embedder + 仅 k_norm)           │
                           └──────────────────────────────────────┘
                               │                    │
                              Yes                   No
                               │         (Nunchaku ZIT 仅有 norm_k)
                               │                    │
                               ▼                    ▼
...
| 后续计划 | `LUMINA_ZIMAGE_COMFY_IMPORT_PLAN.md`（仅本地 `docs/`，不入库） |
