# Z Image Hybrid Pack — ConvRot NVFP4 + INT8 Protect LoRA Bake (from v3.3.2)

**Baseline:** tag `v3.3.2` (`23ca013`)  
**Documented HEAD:** `d77ff3f`  
**Scope:** Hybrid Z Image packs (ConvRot NVFP4 Linear + ConvRot INT8 protect Linear) and LoRA bake under Dynamic VRAM.

This guide covers **only LoRA bake changes from v3.3.2 to current**. Same-period CI / README work is out of scope.
