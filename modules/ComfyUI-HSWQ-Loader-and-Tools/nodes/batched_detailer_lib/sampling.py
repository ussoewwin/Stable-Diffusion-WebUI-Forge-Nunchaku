"""
Sampling helpers for Batched Detailer.

Developed based on ComfyUI-Impact-Pack modules/impact/impact_sampling.py
(ltdrdata, GPL-3.0).
"""
...
try:
    ...
    logging.warning(
        "\n#############################################\n"
        "[HSWQ BatchedDetailer] ComfyUI is an outdated version.\n"
        "#############################################\n"
    )
    raise Exception("[HSWQ BatchedDetailer] ComfyUI is an outdated version.")
